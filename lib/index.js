                    ...
                    case "code":
                        ...
                        return (React.createElement(presentational_components_1.Cell, { key: cellId, className: "cell" },
                            React.createElement(presentational_components_1.Input, { hidden: sourceHidden, className: "input-container" },
                                React.createElement(presentational_components_1.Prompt, { className: "prompt", counter: cell.get("execution_count") }),
                                React.createElement(presentational_components_1.Source, { language: language, theme: this.props.theme }, source)),
                            React.createElement(presentational_components_1.Outputs, { hidden: outputHidden, expanded: cell.getIn(["metadata", "outputExpanded"]) || true },
                                React.createElement(display_area_1.Display, { displayOrder: this.props.displayOrder, outputs: cell.get("outputs").toJS(), transforms: this.props.transforms }))));
                    case "markdown":
                        ...
                        return (React.createElement(presentational_components_1.Cell, { key: cellId, className: "cell" },
                            React.createElement(ContentMargin, { className: "markdown" },
                                React.createElement(react_markdown_1.default, { escapeHtml: false, source: source, plugins: remarkPlugins, renderers: remarkRenderers }))));
                    case "raw":
                        return (React.createElement(presentational_components_1.Cell, { key: cellId, className: "cell" },
